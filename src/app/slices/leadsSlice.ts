...
export const fetchLeads = createAsyncThunk('leads/fetchLeads', async (_, { rejectWithValue }) => {
  try {
    const response = await fetch('https://sbiapi.sustainnovatechlabs.com/api/admin/getAllLeads', {
...
export const fetchLeadById = createAsyncThunk('leads/fetchLeadById', async (id: number, { rejectWithValue }) => {
  try {
    const response = await fetch(`https://sbiapi.sustainnovatechlabs.com/api/admin/getLeadsById?id=${id}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
...
export const addLead = createAsyncThunk('leads/addLead', async (formData: LeadFormData, { rejectWithValue, dispatch }) => {
  try {
    const response = await fetch('https://sbiapi.sustainnovatechlabs.com/api/admin/addLeads', {
      method: 'POST',
...
export const editLead = createAsyncThunk('leads/editLead', async (payload: { formData: LeadFormData, id: number }, { rejectWithValue }) => {
  ...
  try {
    const response = await fetch(`https://sbiapi.sustainnovatechlabs.com/api/admin/editLeads`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
...
export const deleteLead = createAsyncThunk('leads/deleteLead', async (id: number, { rejectWithValue }) => {
  try {
    const response = await fetch(`https://sbiapi.sustainnovatechlabs.com/api/admin/deleteLead?id=${id}`, {
      method: 'PUT',
      headers: { 'Authorization': `Bearer ${token}` }
    });
    const result = await response.json();
...
export const convertToOrder = createAsyncThunk('leads/convertToOrder', async (id: number, { rejectWithValue }) => {
  try {
    const response = await fetch(`https://sbiapi.sustainnovatechlabs.com/api/admin/convertLeadsToOrder?id=${id}`, {
      method: 'PUT',
      headers: { 'Authorization': `Bearer ${token}` }
    });
    const result = await response.json();
...
export const fetchEstimations = createAsyncThunk('leads/fetchEstimations', async (leadId: number, { rejectWithValue }) => {
  try {
    const response = await fetch(`https://sbiapi.sustainnovatechlabs.com/api/admin/getEstimation?leadId=${leadId}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
...
export const deleteEstimation = createAsyncThunk('leads/deleteEstimation', async (estimationId: number, { rejectWithValue }) => {
  try {
    const response = await fetch(`https://sbiapi.sustainnovatechlabs.com/api/admin/deleteEstimation?id=${estimationId}`, {
      method: 'DELETE',
      headers: { 'Authorization': `Bearer ${token}` }
    });
    const result = await response.json();
